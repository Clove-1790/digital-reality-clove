...
const SEED_ACTIVITIES: Activity[] = [
  { id: "a1", projectId: "p1", activityType: "Drone LiDAR Survey", date: "16 May 2024", location: "Kagaznagar", lat: 16.7563, lng: 80.4356, equipmentUsed: ["Trinity F90+", "GS18 DGPS"], areaCovered: 12.5, progress: 65, remarks: "Weather good. Completed Area 12.50 sqkm.", photos: [] },
  { id: "a2", projectId: "p2", activityType: "GNSS Control Survey", date: "15 May 2024", location: "Guntakal", lat: 15.1667, lng: 77.3667, equipmentUsed: ["Leica GS18"], areaCovered: 8.0, progress: 50, remarks: "Set up 12 GCPs along corridor.", photos: [] },
  { id: "a3", projectId: "p1", activityType: "Ground Truth Verification", date: "14 May 2024", location: "Kagaznagar", lat: 16.7563, lng: 80.4356, equipmentUsed: ["Leica TS16"], areaCovered: 3.2, progress: 80, remarks: "Cross-checked with design data.", photos: [] },
];
