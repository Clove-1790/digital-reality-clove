          ...
          <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <View style={styles.cardHeader}>
              ...
              <View style={[styles.pctBadge, { backgroundColor: colors.secondary }]}>
                <Text style={[styles.pctText, { color: colors.primary }]}>{item.progress}%</Text>
              </View>
            </View>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailItem}>
                ...
                <Text style={[styles.detailText, { color: colors.mutedForeground }]}>{item.areaCovered} sqkm</Text>
              </View>
            </View>

            {item.equipmentUsed.length > 0 && (
              <View style={styles.tagsRow}>
                {item.equipmentUsed.map((eq) => (
            ...
            {item.remarks ? (
              <Text style={[styles.remarks, { color: colors.mutedForeground }]} numberOfLines={2}>{item.remarks}</Text>
            ) : null}
          </View>
        )}
        ListEmptyComponent={
