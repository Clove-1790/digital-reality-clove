...
export default function DashboardScreen() {
  ...
  const { user, projects, activities, equipment } = useApp();
  ...
  return (
    ...
    >
      ...
      <View style={styles.statsGrid}>
        ...
        <StatCard label="Pending Billing" value={`₹${(pendingBilling / 100000).toFixed(2)}L`} color={colors.orange} icon="credit-card" />
      </View>
