...
export default function EquipmentScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
        ...
        renderItem={({ item }) => (
          <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            <View style={styles.cardInfo}>
              ...
              {item.assignedTo ? (
                <Text style={[styles.assignedTo, { color: colors.mutedForeground }]}>Assigned to: {item.assignedTo}</Text>
              ) : null}
            </View>
      ...
      <TouchableOpacity style={[styles.fab, { backgroundColor: colors.primary, bottom: insets.bottom + 20 }]} activeOpacity={0.85}>
